...
export async function GET(
  ...
  try {
    ...
    const width = clamp(
      Number(searchParams.get("width") || DEFAULT_WIDTH),
      320,
      4096,
    );
    const height = clamp(
      Number(searchParams.get("height") || DEFAULT_HEIGHT),
      320,
      4096,
    );
    ...
    const err = (
      ...
      >
        ...
        >
          <div style={{ fontWeight: 800, fontSize: 40, marginBottom: 12 }}>
            Leaderboard Image
          </div>
