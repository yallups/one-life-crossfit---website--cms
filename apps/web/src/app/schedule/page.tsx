            ...
            >
              <div className={`w-full flex flex-col items-center text-center`}>
                <p className={"md:max-w-1/2"}>
                  Explore our <strong>CrossFit class schedule</strong>,{" "}
                  <strong>personal training</strong>, <strong>open gym</strong>,
                  and <strong>nutrition coaching</strong> availability.
                </p>
              </div>
            </CommonTextComponent>
          </div>
      ...
      <section aria-labelledby="schedule-title">
        <div className="container mx-auto px-4 md:px-6">
          ...
          >
            <h2
              id="schedule-title"
              className={"text-balance font-semibold text-2xl lg:text-3xl"}
            >
            ...
            <h3 className={"text-balance font-bold text-xl lg:text-2xl"}>
              New to CrossFit? Not sure where to start?
            </h3>
            <p>
              Start with a{" "}
              <Link
              ...
              and we’ll help you pick the right session.
            </p>
