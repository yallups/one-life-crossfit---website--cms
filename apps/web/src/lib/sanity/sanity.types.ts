...
export type GoogleReviews = {
  ...
  nameDisplay?: "firstAndLastInitials" | "fullName" | "firstNamesOnly";
...
export type Layout = {
  ...
  badge?: string;
  title?: string;
  variant?: "imageRight" | "imageLeft" | "centered" | "background";
  richText?: Array<{
    children?: Array<{
      marks?: Array<string>;
      text?: string;
...
export type Settings = {
  ...
  googleReviewsFeaturableId?: string;
  wodifyApiToken?: string;
  socialLinks?: {
    linkedin?: string;
    facebook?: string;
    yelp?: string;
...
export type QueryHomePageDataResult = {
  ...
  pageBuilder: Array<{
    ...
    maxCharacters?: number;
    logoVariant?: "full" | "icon";
    nameDisplay?: "firstAndLastInitials" | "firstNamesOnly" | "fullName";
    structuredData?: boolean;
    hideDate: null;
    showReviewDate: null;
    showReviewer: null;
    ...
    badge?: string;
    title?: string;
    variant?: "background" | "centered" | "imageLeft" | "imageRight";
    richText: Array<{
      children?: Array<{
        marks?: Array<string>;
        text?: string;
...
// Query: *[_type == "settings"][0]{    _id,    _type,    siteTitle,    logo {        "id": asset._ref,  "preview": asset->metadata.lqip,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }    },    siteDescription,    socialLinks{      linkedin,      yelp,      facebook,      twitter,      instagram,      youtube    }  }
...
// Query: *[_type == "settings"][0]{    _id,    _type,    siteTitle,    siteDescription,    "logo": logo.asset->url + "?w=80&h=40&dpr=3&fit=max",    "socialLinks": socialLinks,    "contactEmail": contactEmail,    telephone,    address{      street,      city,      state,      zip,      placeId    },    hours[]{day, closed, open, close},    "googleReviewsFeaturableId": googleReviewsFeaturableId,   }
