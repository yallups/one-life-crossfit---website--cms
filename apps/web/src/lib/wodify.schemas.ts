...
export const WodifyLocationSchema = z
  .object({
    // Names
...
export const WodifyClassSchema = z
  .object({
    ...
    coach_id: z.union([z.string(), z.number()]).optional().nullable(),
...
// Coaches
export const WodifyCoachSchema = z
  .object({
    id: z.union([z.string(), z.number()]),
...
// Workouts (WOD)
export const WodifyWorkoutSchema = z
  .object({
    id: z.union([z.string(), z.number()]),
...
export type WodifyWorkout = z.infer<typeof WodifyWorkoutSchema>;

// Services (for appointments/bookings)
export const WodifyServiceSchema = z
  .object({
    id: z.union([z.string(), z.number()]),
    name: z.string().optional().nullable(),
...
export type WodifyService = z.infer<typeof WodifyServiceSchema>;

// Programs
export const WodifyProgramSchema = z
  .object({
    id: z.union([z.string(), z.number()]),
    name: z.string().optional().nullable(),
    program_name: z.string().optional().nullable(),
...
export type WodifyProgram = z.infer<typeof WodifyProgramSchema>;
